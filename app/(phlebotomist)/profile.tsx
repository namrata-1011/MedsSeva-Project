  ...
  const menuItems = [
    {
     ...
     onPress: () => router.push('/(phlebotomist)/(profile-stack)/edit-profile' as any),
    },
{
      icon: 'cog-outline',
      label: 'Settings',
      subtitle: 'Change password and preferences',
      onPress: () => router.push('/(phlebotomist)/(profile-stack)/settings' as any),
    },
    {
      icon: 'calendar-clock',
      label: 'Availability',
      subtitle: 'Manage your working hours',
      onPress: () => router.push('/(phlebotomist)/(profile-stack)/availability' as any),
    },
    {
      icon: 'hospital-building',
      label: 'My Branch',
      subtitle: profile?.branchName || 'View branch information',
      onPress: () => router.push('/(phlebotomist)/(profile-stack)/my-branch' as any),
    },
    {
      icon: 'star-outline',
      label: 'Ratings',
      ...
      onPress: () => router.push('/(phlebotomist)/(profile-stack)/ratings' as any),
    },
    {
      icon: 'robot-outline',
    ...
    },
    {
      ...
      onPress: () => router.push('/(phlebotomist)/(profile-stack)/legal' as any),
    },
  ];
